  ...
  it("Should NOT allow non owner to reveal winners", function() {
    ...
    ***********/
    ...
    .then(function(result) {
      ...
      ***********/
      assert.notEqual(result[0], '0x0000000000000000000000000000000000000000','Winner adders is not the default address');
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
      assert.notEqual(result[1], '0x0000000000000000000000000000000000000000','Winner adders is not the default address');
      /**********
      ...
      ***********/
      ...
      HINT:     Default address is '0x0000000000000000000000000000000000000000'
                ...
                Parameters for notEqual : (result, default address , message);
      ***********/
     assert.notEqual(result[2], '0x0000000000000000000000000000000000000000','Winner adders is not the default address');
    })
  });
});